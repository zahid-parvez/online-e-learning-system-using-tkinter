...
def take_exam(user_name):
    ...
    class Quiz:
        ...
        def display_question(self):
            ...
            q_no = Label(gui, text=question[self.q_no], width=65,
        ...
        def display_title(self):
            ...
            title = Label(gui, text="Group-4 QUIZ",
                          width=55, bg="grey", fg="indigo", font=("Algerian", 20, "italic", "bold"))
    ...
    gui.geometry("930x450")

    # set the title of the Window
    gui.title("Group-4 Quiz")

    # get the data from the json file
    quiz_list = ['pythonquiz.json', 'Cquiz.json', 'cppquiz.json', 'javaquiz.json']
    rand_ = random.randint(0,3)
    with open(quiz_list[rand_]) as f:
        data = json.load(f)
